...
Referenced platform docs: `docs/18_led_exposure_bar_spec.md`, `hardware/design_targets_revA.yaml`
...
7. Confirmation that interface drawings may be published in an open service manual.
